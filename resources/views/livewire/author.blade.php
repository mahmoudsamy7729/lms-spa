<div class="page-content-wrapper" x-data="{ createForm: false , showTable:true , authorName: ''}">
  <!--start sidebar -->
    ...
    <div class="page-content">
      ...
      <div x-show="showTable" x-transition.delay.100ms>
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <div class="btn-group">
                <button type="button" class="btn btn-dark" x-on:click="createForm = true , showTable = false">Add Author</button>
              </div>
            </div>
        </div>
            ...
            <div class="table-responsive mt-3">
              <table class="table align-middle table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>AU-{{str_pad($author->id,6,"0",STR_PAD_LEFT)}}</td>
                    <td>
          ...
          <div class="col-xl-12  mx-auto">
            <div class="card">
              <div class="card-header px-4 py-3">
                <h5 class="mb-0 text-center">Add Author</h5>
              </div>
              <div class="card-body p-4">
                ...
                " wire:submit.prevent="store">
                  <div class="col-12">
                    <label for="bsValidation1" class="form-label">Author Name</label>
                    <input type="text" class="form-control" id="bsValidation1" x-model="authorName" placeholder="Author Name" wire:model.lazy="author_name" required>
                  </div>
